...
This is a half-day/full-day hands-on REST tutorial based on techniques described in [REST in Practice: Hypermedia and Systems Architecture](http://restinpractice.com). 
...
[Progressive .NET Tutorials](http://skillsmatter.com/event/open-source-dot-net/progressive-dot-net-tutorials-2011/cs-2275)
